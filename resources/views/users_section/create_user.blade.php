                ...
                <div class="col-12 col-md-9 col-lg-7 col-xl-6 col-xxl-5">
                    {{-- <div class="card border border-light-subtle rounded-4">
                        <div class="card-body p-3 p-md-4 p-xl-5">
                            ...
                            <form action="{{ route('users_section.store') }}" method="post">
                                ...
                                <div class="row gy-3 overflow-hidden">
                                    ...
                                    <div class="col-12">
                                        <div class="form-floating mb-3">
                                            <input type="text" value="" class="form-control" name="username" id="username" placeholder="name@example.com" >
                    ...
                    <div class="container2-0">
                        <div class="heading">Ajouter un utilisateur</div>
                        <form class="form1" action="{{ route('users_section.store') }}" method="post">
                            @csrf
                            ...
                            <input type="text" value="{{ old('username') }}" class="input" name="username" id="username" placeholder="Nom d'utilisateur..."/>
                            
                            {{-- <label for="email">Email</label> --}}
                            <input type="`text" value="{{ old('email') }}" class="input" name="email" id="email" placeholder="name@example.com" >
